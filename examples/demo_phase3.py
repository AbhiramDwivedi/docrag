...
def demo_knowledge_graph_integration():
    ...
    try:
        from ingest.knowledge_graph import KnowledgeGraph, KnowledgeGraphBuilder, Entity, Relationship
...
def demo_comprehensive_reporting():
    ...
    try:
        from agent.plugins.comprehensive_reporting import ComprehensiveReportingPlugin
...
def demo_document_relationships():
    ...
    try:
        from agent.plugins.document_relationships import DocumentRelationshipPlugin
